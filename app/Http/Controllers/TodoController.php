...
class TodoController extends Controller
{
    public function create() {
        ...
        $data = compact('url', 'taskName', 'cuName', 'title', 'submitText', 'status', 'dueDate', 'catWp', 'catLara', 'catMern', 'assignTommy', 'assignBobby', 'assignYonny', 'priorityLow', 'priorityMedium', 'priorityHigh', 'mediaSourceWapp', 'mediaSourceLkd', 'mediaSourceSkp', 'statusOngoing', 'statusWorking', 'statusComplete', 'taskNote','taskDes' );
    ...
    public function store(Request $request) {
        ...
        $todoSave->task_des = $request->task_des;
        $todoSave->save();
    ...
    public function update($id) {
        ...
        if(is_null($todoDel)) {
            ...
            $data = compact('url', 'todoDel', 'taskName', 'cuName', 'title', 'submitText', 'status', 'dueDate' , 'catWp', 'catLara', 'catMern', 'assignTommy', 'assignBobby', 'assignYonny', 'priorityLow', 'priorityMedium', 'priorityHigh' , 'mediaSourceWapp', 'mediaSourceLkd', 'mediaSourceSkp', 'statusOngoing', 'statusWorking', 'statusComplete', 'taskNote', 'taskDes');
    ...
    public function update_store($id, Request $request) {
        ...
        $todoUpdate->task_des = $request->task_des;
        $todoUpdate->save();
